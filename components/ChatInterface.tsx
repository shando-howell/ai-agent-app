...
const ChatInterface = ({ chatId, initialMessages}: ChatInterfaceProps) => {
    ...
    const formatTerminalOutput = (
        ...
        const terminalHtml = `<div class="bg-[#1e1e1e] text-white font-mono p-2 rounded-md 
        my-2 overflow-x-auto whitespace-normal max-w-[600px]">
            ...
            <pre class="text-yellow-400 mt-0.5 whitespace-pre-wrap oveerflow-x-auto">${formatToolOutput(input)}</pre>
