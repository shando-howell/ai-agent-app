...
export default function landingPage() {
  return (
    ...
    flex items-center justify-center">
      ...
      <section className="w-full px-4 py-8 mx-auto max-w-7xl sm:px-6 lg:px-8 flex 
      flex-col items-center space-y-10 text-center">
        {/* Hero Content */}
        ...
        {/* Features Grid*/}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-16 pt-8
        max-w-3xl max-auto">
          {[
            { 
              title: "Fast", 
